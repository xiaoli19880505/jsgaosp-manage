...
public class BcSysApplicationAction {
	 ...
	 * 
	 * @ResponseBody public BcSysArgs getSysargsById(BcSysArgs args){ if(args !=
	 * null && StringUtils.isNotEmpty(args.getId())){ return
	 * bcSysArgsService.getSysArgsById(args); } return new BcSysArgs(); }
	 */
