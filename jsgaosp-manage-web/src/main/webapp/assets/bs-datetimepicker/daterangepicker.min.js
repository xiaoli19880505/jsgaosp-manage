!function(b) {
	var a = function(k, s, i) {
		...
		this.endDate.dayOfYear(this.endDate.dayOfYear()+7)
		this.minDate = false;
		this.maxDate = false;
		...
		this.separator = " - ";
		if (b.fn.daterangepicker.locale) {
			this.locale = b.fn.daterangepicker.locale;
		} else {
			this.locale = {
				applyLabel : "Apply",
				cancelLabel : "Cancel",
	...
	a.prototype = {
		...
		move : function() {
			...
			if (this.opens == "left") {
				...
				if (this.container.offset().left + this.container.outerWidth() > b(window)
						.width()) {
					this.container.css({
						left : "auto",
						right : 0
		...
		enterRange : function(f) {
			...
			if (c == this.locale.customRangeLabel) {
				...
				var d = this.ranges[c];
				this.container.find("input[name=daterangepicker_start]")
						.val(d[0].format(this.format));
				this.container.find("input[name=daterangepicker_end]").val(d[1]
						.format(this.format))
			}
		},
		...
		clickRange : function(f) {
			...
			if (c == this.locale.customRangeLabel) {
				...
				this.leftCalendar.month.month(this.startDate.month())
						.year(this.startDate.year())
						.hour(this.startDate.hour()).minute(this.startDate
								.minute());
				this.rightCalendar.month.month(this.endDate.month())
						.year(this.endDate.year()).hour(this.endDate.hour())
		...
		enterDate : function(f) {
			...
			if (d.hasClass("left")) {
				this.container.find("input[name=daterangepicker_start]")
						.val(this.leftCalendar.calendar[g][c]
								.format(this.format))
			} else {
				this.container.find("input[name=daterangepicker_end]")
						.val(this.rightCalendar.calendar[g][c]
								.format(this.format))
			}
		},
		...
		updateCalendars : function() {
			...
			this.container.find(".calendar.left").html(this.renderCalendar(
					this.leftCalendar.calendar, this.startDate, this.minDate,
					this.maxDate));
			this.container.find(".calendar.right").html(this.renderCalendar(
					this.rightCalendar.calendar, this.endDate, this.startDate,
					this.maxDate));
