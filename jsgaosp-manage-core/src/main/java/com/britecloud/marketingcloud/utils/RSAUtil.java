...
public class RSAUtil {
    ...
    public static Map<String, String> getKey() {
        ...
        try {
            ...
            result.put(PUBLIC_KEY, Base64.encode(key.getEncoded()));
            key = (Key) keyMap.get(PRIVATE_KEY);
            result.put(PRIVATE_KEY, Base64.encode(key.getEncoded()));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return result;
