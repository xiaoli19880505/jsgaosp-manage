...
public class JavaScriptUtil
{
    ...
    protected static String replace(String src, String oldStr, String newStr, boolean caseSensitive) {
		int index;
		StringBuffer buffer;
		String s = src;

		if (StringUtils.isEmpty(src) || StringUtils.isEmpty(oldStr) || (newStr == null)) {
			return src;
		}
	...
	public static String replace(String src, String oldStr, String newStr) {
		return replace(src, oldStr, newStr, true);
	}
