...
import com.britecloud.marketingcloud.core.dao.jdbc.sql.beans.Probe;
import com.britecloud.marketingcloud.core.dao.jdbc.sql.beans.ProbeFactory;
...
public abstract class ConditionalTagHandler extends BaseTagHandler {
	...
	protected Object convertValue(Class type, String value) {
		if (type == String.class) {
			...
			return DateUtils.toDate(DATE_MASK, value);
